...
echo ""
echo "⏳ IMPORTANT: Wait 15-30 seconds for backend to fully start!"
echo "   Look for 'Started EmployeeLoanApplication' in backend terminal"
echo ""
echo "🔐 Demo Credentials:"
echo "   👤 Employee:      employee@company.com / pass123"
echo "   💼 Loan Officer:  officer@company.com / pass123"
echo "   📊 Accountant:    accountant@company.com / pass123"
echo "   🔧 Admin:         admin@company.com / pass123"
echo ""
echo "📝 Note: Only Admins can create new users (no public registration)"
echo ""
